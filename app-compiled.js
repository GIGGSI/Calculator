...
function square() {
    rl.question('If you want to check the Square Area push: (v) or Square Perimeter (k): ', function (answer) {
        if (answer == 'v') {
            return squareAreas();
        } else {
...
function squarePerimeters() {
    rl.question('Enter the length of side: ', function (number) {
        ...
        rl.question('Find the perimeter of Square again?: (yes)  or go back: (b): ', function (answer) {
            if (answer == 'yes') {
                squarePerimeters();
            } else {
                Calculator();
...
function triangle() {
    rl.question('If you want to check the Triangle Area push: (v) or Triangle Perimeter (k): ', function (answer) {
        if (answer == 'v') {
            triangleAreas();
        } else {
            trianglePerimeters();
...
function triangleAreas() {
    rl.question('Enter the base: ', function (base) {
        rl.question('Enter the height: ', function (height) {
            ...
            rl.question('Find the area of Triangle again?: (yes) or go back: (b): ', function (answer) {
                if (answer == 'yes') {
                    triangleAreas();
                } else {
                    Calculator();
    ...
    rl.question('Enter the a: ', function (a) {
        rl.question('Enter the b: ', function (b) {
            rl.question('Enter the c: ', function (c) {
                ...
                rl.question('Find the perimeter of Triangle again?: (yes) or go back: (b): ', function (answer) {
                    if (answer == 'yes') {
                        trianglePerimeters();
                    } else {
                        Calculator();
...
function parallelograms() {
    rl.question('If you want to check the Parallelogram Area push: (v) or Parallelogram Perimeter (k): ', function (answer) {
        if (answer == 'v') {
            parallelogramAreas();
        } else {
...
function parallelogramAreas() {
    rl.question('Enter the Base: ', function (base) {
        rl.question('Enter the Vertical Height: ', function (verticalHeight) {
            ...
            rl.question('Find the area of Parallelogram again?: (yes) or go back: (b): ', function (answer) {
                if (answer == 'yes') {
                    parallelogramAreas();
                } else {
                    Calculator();
...
function parallelogramPerimeters() {
    rl.question('Enter the width: ', function (width) {
        rl.question('Enter the height:', function (height) {
            ...
            rl.question('Find the perimeter of Parallelogram again?: (yes) or go back: (b): ', function (answer) {
                if (answer == 'yes') {
                    parallelogramPerimeters();
                } else {
                    Calculator();
...
function circle() {
    rl.question('If you want to check the Circle Area push: (v) or Circle Perimeter (k): ', function (answer) {
        if (answer == 'v') {
            circleAreas();
        } else {
            circlePerimeters();
...
function circleAreas() {
    rl.question('Enter the radius: ', function (radius) {
        ...
        rl.question('Find the area of Circle again?: (yes) or go back: (b): ', function (answer) {
            if (answer == 'yes') {
                circleAreas();
            } else {
                Calculator();
...
function circlePerimeters() {
    rl.question('Enter the radius: ', function (radius) {
        ...
        rl.question('Find the perimeter of Circle again?: (yes) or go back: (b): ', function (answer) {
            if (answer == 'yes') {
                circlePerimeters();
            } else {
                Calculator();
...
function rectangle() {
    rl.question('If you want to check the Rectangle Area push: (v) or Rectangle Perimeter (k): ', function (answer) {
        if (answer == 'v') {
            rectangleAreas();
        } else {
            rectanglePerimeters();
...
function rectangleAreas() {
    rl.question('Enter the width: ', function (width) {
        rl.question('Enter the height: ', function (height) {
            ...
            rl.question('Find the area of Rectangle again?: (yes) or go back: (b): ', function (answer) {
                if (answer == 'yes') {
                    rectangleAreas();
                } else {
                    Calculator();
...
function rectanglePerimeters() {
    rl.question('Enter the width: ', function (width) {
        rl.question('Enter the height: ', function (height) {
            ...
            rl.question('Find the are of Rectangle again?: (yes) or go back: (b): ', function (answer) {
                if (answer == 'yes') {
                    rectanglePerimeters();
                } else {
                    Calculator();
